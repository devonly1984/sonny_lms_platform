"use client";
import CourseProgess from "@/components/courses/CourseProgess";
...
import { GetCompletionsQueryResult, QueryResult } from "@/sanity.types";
import { ArrowLeft, Check, Library, PlayCircle, X } from "lucide-react";
